    ...
    <body>
        <div class="container">
           <h3><img height="50" width="55" src="<c:url value="/static/logo.png"/>"/><a href="/">Contacts List</a></h3>
            ...
            <div class="container">
<%--                <form role="form" class="form-horizontal" action="/upload_json_file" method="GET">--%>
                    <button type="button" id="upload_file" class="btn btn-default navbar-btn">Upload Contacts From JSON</button>
<%--                </form>--%>
            </div>
        ...
        <script>
            ...
            $('#upload_file').click(function(){
                window.location.href='/upload_json_file'
            });
        </script>
    </body>
</html>